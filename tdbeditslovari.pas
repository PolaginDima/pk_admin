...
begin
  if fdds.DataSet.Modified then
    begin
         try
           ds_state:= fqqr.State;
           //showmessage(Generator+lineending+IDPole);
           if fqqr.State=db.dsInsert then
                begin
                     ProcGenerator(Generator,IDPole,fqqr);
                end;
           fdds.DataSet.Post;
           fqQR.ApplyUpdates;
         except
...
procedure TDBEditSlovar.FormDestroy(Sender: TObject);
{var
  i:integer;}
begin
